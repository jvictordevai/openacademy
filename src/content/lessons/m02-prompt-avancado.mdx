...
task:
  prompt: "Pegue um problema real do seu negócio (decisão pendente, análise complexa). Escreva o prompt usando XML tags + peça Chain of Thought explícito ('mostre raciocínio antes da conclusão'). Cole o prompt + a saída do Claude."
  criteria: "Prompt usa pelo menos 2 tags XML diferentes. Saída mostra raciocínio passo a passo separado da conclusão final."
  minutes: 12
---
...
Esse prompt extrai do Claude o tipo de análise que um analista sênior levaria 2-3 dias pra produzir.
