...
task:
  prompt: "Publique um dashboard real no Lovable conectado a uma planilha sua (Google Sheets ou Excel 365). Compartilhe a URL pública (ou cole o link de preview)."
  criteria: "URL `.lovable.app` acessível, mostrando dado real da sua empresa atualizando da planilha. Pelo menos 3 KPIs visíveis + 1 filtro funcionando."
  minutes: 25
---
...
<AnnotatedScreenshot
  alt="Workspace inicial do Lovable com chat de criação"
  source="lovable.dev"
  href="https://lovable.dev"
  caption="Tela inicial do Lovable. Onde você descreve o app — o resto é com ele."
  annotations={[
    { x: 50, y: 30, label: 'Chat de criação', text: 'descreva o app em português — quanto mais específico, melhor' },
    { x: 88, y: 18, label: 'Projects', text: 'todos os apps que você já criou' },
    { x: 50, y: 80, label: 'Templates', text: 'pontos de partida prontos (landing, dashboard, CRM, e-com)' },
    { x: 12, y: 50, label: 'Sidebar', text: 'navegação entre projetos e conectores' },
  ]}
/>
...
**Total típico: US$ 25-55/mês** dependendo do volume de uso (Claude Pro + Lovable Pro). Para projeto pequeno, a soma fica perto de US$ 25/mês — Claude Pro já cobre quase tudo.
...
Dashboard funcionando. Próximo passo natural: **fechar o ciclo com segurança** — veja [como blindar o que você acabou de construir](/licoes/m07-aikido).
