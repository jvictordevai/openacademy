...
task:
  prompt: "Liste 3 ativos digitais da sua empresa que NUNCA foram escaneados por ferramenta de segurança (repositório de código, site público, domínio, app interno, etc)."
  criteria: "3 ativos nomeados especificamente (não 'meu site' — `nomedosite.com.br`). Indicar há quanto tempo cada um existe."
  minutes: 4
---
